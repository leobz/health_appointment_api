...
RSpec.describe 'Appointment' do
  context 'validations' do
    ...
    it "is not valid if start_time is out of doctor's working hours" do
      # Working Hour: Monday (10 AM -11 AM)
      create(:working_hour, day_of_week: :monday, start_time: '10:00', end_time: '11:00', doctor: doctor)

      #************************** Invalid day ***********************
      invalid_datetime = DateTime.new(2024, 6 , 7, 10, 0, 0) # (June 7, 2024) is a Friday
      expect(invalid_datetime.monday?).to be(false)

      invalid_appointment = Appointment.new(start_time: invalid_datetime, doctor: doctor, patient: patient)
